...
test_that("when old file and new file are not equal return different hashes", {
    ...
    # the supressWarnings function is used to suppress the warning message
    # which is generated by the compare_file_hashes function
    # causing the test to generate a warning message
